...
sudo apt-get -y --assume-yes -qq install ubuntu-desktop-minimal gnome-software firefox
...
sudo apt-get -y install --assume-yes -qq ./chrome-remote-desktop_current_amd64.deb
